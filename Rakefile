...
def create_tables(database_connection)
  ...
  database_connection.execute("CREATE TABLE style (id INTEGER PRIMARY KEY AUTOINCREMENT, name varchar(50), abv decimal(5,2), calories_per_ounce decimal(5,2))")#^ change style to style_id, add abv and cals to this table
end