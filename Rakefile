...
def create_tables(database_connection)
  ...
  database_connection.execute("CREATE TABLE categories (id INTEGER PRIMARY KEY AUTOINCREMENT, name varchar(50))")#^ change style to category_id, add abv and cals to this table
end